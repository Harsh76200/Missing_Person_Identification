...
<body>
    ...
    <nav class="navbar">
        <div class="max-width">
            <div class="logo"><a href="dashboard.html">We <span>Care...</span></a></div>
            <ul class="menu">
                <li><a href="addmissing.jsp" class="menu-btn">Add Missing Person</a></li>
                <li><a href="viewmissing.jsp" class="menu-btn">View Missing Person</a></li>
...
<body>
    ...
    PreparedStatement stmt = cn.prepareStatement("select * from missingdata");
